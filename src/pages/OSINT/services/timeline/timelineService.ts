...
class TimelineService {
  ...
  async getTimelineEvents(filter?: TimelineFilter): Promise<{ data?: TimelineData; error?: ErrorDetail }> {
    try {
      ...
      const result = await osintApi.post<TimelineData>(osintEndpoints.timeline.events, filter as Record<string, unknown> || {});
  ...
  private getMockTimelineData(filter?: TimelineFilter): TimelineData {
    ...
    const allEvents: TimelineEvent[] = [
      ...
      },
      {
        ...
        relationships: [],
        tags: ['comms', 'threat-actor', 'encryption']
      },
      {
        id: 'evt-005',
      ...
      },
      {
        ...
        relationships: [],
        tags: ['vulnerability', 'zero-day', 'server']
      },
      {
        id: 'evt-007',
        ...
        relationships: [],
        tags: ['data-exfiltration', 'encryption']
      },
      {
        id: 'evt-008',
        ...
        relationships: [],
        tags: ['social-media', 'steganography', 'hidden-message']
      },
      {
        id: 'evt-009',
        ...
        relationships: [],
        tags: ['darkweb', 'marketplace', 'data-breach']
      },
      {
        id: 'evt-010',
        ...
        relationships: [],
        tags: ['physical', 'dead-drop', 'surveillance']
      }
    ];
