...
export const NETRUNNER_ERROR_CODES = {
  ...
  WORKFLOW_EXECUTION_FAILED: 'NET-FLOW-006',
  ...
  BOT_COMMUNICATION_FAILED: 'NET-BOT-006',
  ...
  ANALYZER_CONNECTION_FAILED: 'NET-ANLZ-006',
  ...
  INTEGRATION_DATA_SYNC_FAILED: 'NET-INTG-006'
} as const;
