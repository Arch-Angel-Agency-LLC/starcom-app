...
# Script to recreate the SecureChatAdapter.test.ts file with a clean version

# Path to the file
TEST_FILE="/Users/jono/Documents/GitHub/starcom-app/dapp/src/lib/chat/__tests__/SecureChatAdapter.test.ts"
...
echo "SecureChatAdapter.test.ts has been recreated with a clean version."
echo "The original file was backed up to ${TEST_FILE}.bak"
