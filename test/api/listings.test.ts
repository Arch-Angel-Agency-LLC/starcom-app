// Load ESM JS module dynamically to avoid TS type/export issues
...
describe('/api/listings', () => {
  ...
  it('lists created items and supports basic q filter', async () => {
    await handler(createReq('POST', { cid: 'bafy1', name: 'Alpha Report', price: 5, tags: ['osint'] }), createMockRes());
    await handler(createReq('POST', { cid: 'bafy2', name: 'Bravo Dossier', price: 7, tags: ['sigint'] }), createMockRes());
