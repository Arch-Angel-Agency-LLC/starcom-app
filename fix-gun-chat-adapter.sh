...
# This script fixes corruption in GunChatAdapter.ts
cd /Users/jono/Documents/GitHub/starcom-app/dapp

# Backup the current file
cp src/lib/chat/adapters/GunChatAdapter.ts src/lib/chat/adapters/GunChatAdapter.ts.bak

# Create minimal valid file
cat > src/lib/chat/adapters/GunChatAdapter.ts << 'EOF'
/**
 * GunChatAdapter.ts
 * 
